...
to set / change omniauth API Keys, use environment variables

Facebook:
export FACEBOOK_KEY=SOMETHINGFROMFACEBOOK
export FACEBOOK_SECRET=ASECRETFROMFACEBOOK

Twitter:
export CONSUMER_KEY=SOMETHINGFROMTWITTER
export CONSUMER_SECRET=ASECRETFROMTWITTER
